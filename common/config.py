...
#
# The default environment variable that points to the location of the
# configuration file
#
DEFAULT_ENV = "BLOTTER_OANDA_CONF"

#
# The default path for the v20 configuration file
#
DEFAULT_PATH = "~/.blotter_oanda.conf"


class ConfigPathError(Exception):
    """
    Exception that indicates that the path specifed for a config file
...
class ConfigValueError(Exception):
    """
    Exception that indicates the configuration file is missing
    a required value
    """
